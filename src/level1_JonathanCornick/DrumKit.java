...
public class DrumKit extends MouseAdapter {
	...
	JLabel stringLabelWithImage;
	JLabel brassLabelWithImage;
	...
	private void getGoing() throws MalformedURLException {
		...
		stringLabelWithImage = createLabelImage(DRUM2);
		panel.add(stringLabelWithImage);
		panel.setLayout(new GridLayout());
		frame.pack();
		String DRUM3 = "DRUM3.png";
		brassLabelWithImage = createLabelImage(DRUM3);
		panel.add(brassLabelWithImage);
		panel.setLayout(new GridLayout());
		frame.pack();
		brassLabelWithImage.addMouseListener(this);
		stringLabelWithImage.addMouseListener(this);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (drumClicked == brassLabelWithImage) {
			playSound("DRUM3SOUND.wav");
		}
		if (drumClicked == stringLabelWithImage) {
			playSound("DRUM2SOUND.wav");
		}
